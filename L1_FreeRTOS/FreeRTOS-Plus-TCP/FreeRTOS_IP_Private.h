...
/* Size (in bytes) that needs to be appended to network packets to make them
32-bit aligned. Set to two bytes to pad 14-bit ethernet address enough to
make it start at a 16-bit offset. */
//#define ipconfigPACKET_FILLER_SIZE 2

#define ipconfigIP_TASK_PRIORITY PRIORITY_LOW
...
static __inline UBaseType_t uxGetRxEventCount( void )
{
