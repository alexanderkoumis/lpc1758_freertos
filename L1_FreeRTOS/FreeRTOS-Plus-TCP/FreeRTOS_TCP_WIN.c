...
static __inline BaseType_t xSequenceLessThanOrEqual( uint32_t a, uint32_t b )
{
	/* Test if a <= b
...
static __inline BaseType_t xSequenceLessThan( uint32_t a, uint32_t b )
{
	/* Test if a < b */
...
static __inline BaseType_t xSequenceGreaterThan( uint32_t a, uint32_t b )
{
	/* Test if a > b */
...
static __inline BaseType_t xSequenceGreaterThanOrEqual( uint32_t a, uint32_t b )
{
	/* Test if a >= b */
...
static __inline void vListInsertFifo( List_t * const pxList, ListItem_t * const pxNewListItem )
{
	vListInsertGeneric( pxList, pxNewListItem, &pxList->xListEnd );
}
/*-----------------------------------------------------------*/

static __inline void vListInsertStack( List_t * const pxList, ListItem_t * const pxNewListItem )
{
	vListInsertGeneric( pxList, pxNewListItem, (MiniListItem_t *)pxList->xListEnd.pxNext );
}
/*-----------------------------------------------------------*/

static __inline void vTCPTimerSet( TcpTimer_t *pxTimer )
{
	pxTimer->ulBorn = xTaskGetTickCount ( );
}
/*-----------------------------------------------------------*/

static __inline uint32_t ulTimerGetAge( TcpTimer_t *pxTimer )
{
