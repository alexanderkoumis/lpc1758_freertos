...
static __inline void vStreamBufferClear( xStreamBuffer *pxBuffer )
{
...
static __inline int32_t lStreamBufferSpace( const xStreamBuffer *pxBuffer, int32_t lLower, int32_t lUpper )
{
...
static __inline int32_t lStreamBufferDistance( const xStreamBuffer *pxBuffer, int32_t lLower, int32_t lUpper )
{
...
static __inline int32_t lStreamBufferGetSpace( const xStreamBuffer *pxBuffer )
{
...
static __inline int32_t lStreamBufferFrontSpace( const xStreamBuffer *pxBuffer )
{
...
static __inline int32_t lStreamBufferGetSize( const xStreamBuffer *pxBuffer )
{
...
static __inline int32_t lStreamBufferMidSpace( const xStreamBuffer *pxBuffer )
{
...
static __inline void vStreamBufferMoveMid( xStreamBuffer *pxBuffer, int32_t lCount )
{
...
static __inline BaseType_t xStreamBufferIsEmpty( const xStreamBuffer *pxBuffer )
{
BaseType_t xReturn;
...
static __inline BaseType_t xStreamBufferIsFull( const xStreamBuffer *pxBuffer )
{
...
static __inline BaseType_t xStreamBufferLessThenEqual( const xStreamBuffer *pxBuffer, int32_t ulLeft, int32_t ulRight )
{
BaseType_t xReturn;
...
static __inline int32_t lStreamBufferGetPtr( xStreamBuffer *pxBuffer, uint8_t **ppucData )
{
